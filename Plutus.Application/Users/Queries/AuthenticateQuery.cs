...
{
    public record AuthenticateQuery(string Email, string Password) : IRequest<UserResponse>;
    ...
    public class AuthenticateQueryHandler : IRequestHandler<AuthenticateQuery, UserResponse>
    {
        ...
        public async Task<UserResponse> Handle(AuthenticateQuery request, CancellationToken cancellationToken)
        {
